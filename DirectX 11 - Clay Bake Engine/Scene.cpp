...
Scene::Scene(std::string filePath, int width, int height)
{
	...
	_audioFilePath = data[JSON_SCENE_BACKGROUNDAUDIO];
	_backgroundAudio = new SoundEffect(_audioFilePath, true);
	...
	_prefabs.push_back(Prefab("Player Blue",	"Resources/Sprites/Player1.dds", { 6.0f, 8.0f, 0.0f, 0.0f }, "{ \"rotation\" : 0.0, \"scale\" : [1.75, 1.75] , \"components\" : [{ \"class\" : \"Appearance\", \"constructors\" : [\"Resources/Sprites/Player1.dds\", 6.0, 8.0, 0.0, 0.0, 1.0] }, { \"class\" : \"PlayerController\", \"constructors\" : [1] }, { \"class\" : \"PlayerMagnetism\" }, { \"class\" : \"AABB\", \"constructors\": [ 11, 16 ] }, { \"class\" : \"Rigidbody\" }] }"));
	_prefabs.push_back(Prefab("Player Red",		"Resources/Sprites/Player2.dds", { 6.0f, 8.0f, 0.0f, 0.0f }, "{ \"rotation\" : 0.0, \"scale\" : [1.75, 1.75] , \"components\" : [{ \"class\" : \"Appearance\", \"constructors\" : [\"Resources/Sprites/Player2.dds\", 6.0, 8.0, 0.0, 0.0, 1.0] }, { \"class\" : \"PlayerController\", \"constructors\" : [2] }, { \"class\" : \"PlayerMagnetism\" }, { \"class\" : \"AABB\", \"constructors\": [ 11, 16 ] }, { \"class\" : \"Rigidbody\" }] }"));
	_prefabs.push_back(Prefab("Box",			"Resources/Sprites/Box.dds", { 1.0f, 1.0f, 0.0f, 0.0f }, "{ \"rotation\" : 0.0, \"scale\" : [1.0, 1.0] , \"components\" : [{ \"class\": \"Appearance\", \"constructors\": [ \"Resources/Sprites/Box.dds\", 1.0, 1.0, 0.0, 0.0, 1.0 ] }, { \"class\": \"MagnetBox\" }, { \"class\": \"AABB\", \"constructors\": [ 18.0, 18.0 ] }, { \"class\": \"Rigidbody\" }] }"));
	...
	_prefabs.push_back(Prefab("Lever",			"Resources/Sprites/Lever.dds", { 3.0f, 1.0f, 0.0f, 0.0f }, "{ \"components\": [ { \"class\": \"Appearance\", \"constructors\": [ \"Resources/Sprites/Lever.dds\", 3.0, 1.0, 0.0, 0.0, 1.0 ] }, { \"class\": \"LeverComponent\", \"constructors\": [ 0, \"\" ] }, { \"class\": \"AABB\", \"constructors\": [ 18.0, 5.0, true ] } ], \"rotation\": 0.0, \"scale\": [ 1.0, 1.0 ], \"tag\": \"GameObject\" }"));
