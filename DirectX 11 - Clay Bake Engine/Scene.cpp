...
Scene::Scene(std::string filePath, int width, int height)
{
	...
	_prefabs.push_back(Prefab("Player Blue",	"Resources/Sprites/Player1.dds", { 6.0f, 8.0f, 0.0f, 0.0f }, "{ \"rotation\" : 0.0, \"scale\" : [1.0, 1.0] , \"components\" : [{ \"class\" : \"Appearance\", \"constructors\" : [\"Resources/Sprites/Player1.dds\", 6.0, 8.0, 0.0, 0.0, 1.0, 3.5, 2.5] }, { \"class\" : \"PlayerController\", \"constructors\" : [1] }, { \"class\" : \"AABB\", \"constructors\": [ 11, 16 ] }, { \"class\" : \"Rigidbody\" }] }", Vector2(3.5f, 2.5f)));
	_prefabs.push_back(Prefab("Player Red",		"Resources/Sprites/Player2.dds", { 6.0f, 8.0f, 0.0f, 0.0f }, "{ \"rotation\" : 0.0, \"scale\" : [1.0, 1.0] , \"components\" : [{ \"class\" : \"Appearance\", \"constructors\" : [\"Resources/Sprites/Player2.dds\", 6.0, 8.0, 0.0, 0.0, 1.0, 3.5, 2.5] }, { \"class\" : \"PlayerController\", \"constructors\" : [2] }, { \"class\" : \"AABB\", \"constructors\": [ 11, 16 ] }, { \"class\" : \"Rigidbody\" }] }", Vector2(3.5f, 2.5f)));
